...
const navCols = [
  ...
  },
  {
    head: 'Explore',
    links: [
      { label: 'Why Contractors Choose It', href: '#why' },
        ...
        <div className="content-wrap">
          ...
          <Reveal className="relative mb-16 text-center">
            ...
            >
              Never miss another
              <br />
              <span className="gradient-text">service call.</span>
            </h2>
            <MagneticButton
              href={BOOK_URL}
          ...
          <div className="mb-12 grid grid-cols-2 gap-10 md:grid-cols-4">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              >
                AI receptionists for HVAC contractors. Every inbound call
                answered, every past customer worked, booked straight into your
                dispatch software.
              </p>
            </div>
            ...
            <div>
              ...
              <p
                className="mb-4 font-jakarta text-sm text-ds-muted"
                style={{ letterSpacing: '-0.02em', lineHeight: '1.6' }}
              >
