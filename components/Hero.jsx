...
/* ── 3D phone mockup: a live inbound HVAC call ────────────── */
        ...
        <div className="px-5 pb-4 pt-3">
          <div className="flex items-center gap-3">
            <div
              ...
              style={{
                background: 'radial-gradient(50% 58% at 50% 95%, #E5C463, #C9A227)',
              }}
            >
              <Headset size={20} />
            </div>
          ...
          <div className="mt-3 space-y-2">
            <div className="max-w-[88%] rounded-2xl rounded-tl-sm bg-white px-3 py-2 shadow-sm">
              <p className="font-jakarta text-[10.5px] leading-snug text-ds-text">
                Thanks for calling Summit Heating &amp; Air. I can get you
                scheduled. What is going on with your system?
              </p>
            </div>
            <div
            ...
            >
              <p className="font-jakarta text-[10.5px] leading-snug">
                My AC quit cooling last night.
              </p>
            </div>
            <div className="max-w-[88%] rounded-2xl rounded-tl-sm bg-white px-3 py-2 shadow-sm">
              <p className="font-jakarta text-[10.5px] leading-snug text-ds-text">
                Sorry about that. I have a tech open today between 2 and 4.
                Booking that into your account now.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <span className="font-jakarta text-[11px] font-bold text-[#1B7E45]">
              Job booked · Today 2-4 PM · ServiceTitan
            </span>
          </motion.div>
        </div>
      </div>
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-content px-5 py-12 sm:px-8 lg:px-12 lg:py-16">
        <div className="content-wrap">
          <div className="grid items-center gap-12 lg:grid-cols-2 xl:gap-16">
            ...
            <motion.div style={{ y: copyY }}>
              ...
              >
                AI receptionist that answers every call{' '}
                <strong className="font-bold text-ds-heading">24/7</strong>. Plus
                we reactivate your existing customer database.{' '}
              ...
              <motion.div
                ...
                className="mb-7 grid max-w-xl grid-cols-1 gap-3 sm:grid-cols-2"
              >
                <LiveCountdown />
                <div className="card-glass flex items-center gap-4 px-5 py-4">
              ...
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 0.8, delay: 1.62 }}
            ...
            >
              ...
              <FloatChip
                ...
                text="Job booked into ServiceTitan"
                color="#22A559"
                delay={2.0}
