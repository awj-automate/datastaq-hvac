...
import { Puzzle, Headset, Chart, Check } from '@/components/Icons';
...
const STEPS = [
  {
    ...
    tag: 'Connect',
    accent: '#C9A227',
    title: 'We integrate with your software',
    dur: 'Days 1-3',
    body: 'A fast, hands-off setup. We plug into the dispatch software you already run and pull in your customer history.',
    points: [
      'Connect to ServiceTitan, Housecall Pro, or Jobber',
      'Export and prep your past-customer database',
      'Map your service areas and call-handling rules',
    ],
  },
  {
    n: '02',
    tag: 'Launch',
    accent: '#8B6CF0',
    title: 'Inbound goes live, reactivation starts',
    dur: 'Days 4-14',
    body: 'Your AI receptionist starts answering every call while the outbound campaign begins working your database.',
    points: [
      'AI receptionist answers every inbound call, 24/7',
      'Database reactivation campaign goes live',
      'Booked jobs start landing on your dispatch board',
    ],
  },
  {
    n: '03',
    tag: 'Deliver',
    accent: '#22A559',
    title: "20 appointments, or you don't pay",
    dur: 'Days 15-60',
    body: 'The system books toward your guarantee while we monitor, report, and tune the calls every week.',
    points: [
      '20 qualified appointments inside 60 days',
      'Weekly reporting and call tuning',
      'Miss the 20 and you get a full refund',
    ],
  },
];
...
function ScanViz({ accent }) {
  const rows = ['ServiceTitan', 'Housecall Pro', 'Jobber', 'Customer database', 'Service areas'];
  return (
        ...
        <div className="content-wrap">
              ...
              <div className="sticky top-28">
                ...
                >
                  <div className="mb-5 flex items-center justify-between">
                    ...
                    >
                      {active === 0 && <Puzzle size={26} />}
                      {active === 1 && <Headset size={26} />}
          ...
          <Reveal className="mt-12 text-center">
            <div className="card-glass inline-flex items-center gap-3 px-6 py-4">
              ...
              >
                Live in 2 weeks. 20 appointments inside 60 days.
              </span>
            </div>
          </Reveal>
        </div>
